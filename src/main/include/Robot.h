...
#include "../cpp/subsystems/subsystem.hpp"
...
public:
        ...
        //constants 
        double kDistancePerRevolution = 18.84;
        double kPulsesPerRevolution = 4096; 
...
private:
        ...
        frc2::CommandJoystick m_operatorPannel{1};
        // drivebase motors
        // xbox controllers
        ...
        void ConfigureBindings(); //configures bindings for robot
        /* Mechanisms */
