...
namespace subsystems
{
    ...
    {        
        //this ->intake_motor.SetNeutralMode(ctre::phoenix::motorcontrol::Brake); // fix this later
        ...
        */
        ...
        this->arm_l.CANSparkBase::SetIdleMode(rev::CANSparkBase::IdleMode::kBrake);
        this->arm_l.CANSparkBase::SetOpenLoopRampRate(0.25);
        this->arm_r.CANSparkBase::SetIdleMode(rev::CANSparkBase::IdleMode::kBrake);
        this->arm_r.CANSparkBase::SetOpenLoopRampRate(0.25);
    }
